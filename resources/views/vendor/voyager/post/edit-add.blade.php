...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.post.update', $dataTypeContent->id) }}@else{{ route('voyager.post.store') }}@endif" method="POST" enctype="multipart/form-data">
