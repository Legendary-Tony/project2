        ...
        <form class="form.data">
            ...
            <div class="sign-u">
                ...
                <div class="sign-up2">
                    ...
                    <input id="first_name" type="text" placeholder=" " class="{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" value="{{ old('first_name') }}" required>
...
<script type="text/javascript">
    ...
    $(".submit").click(function(e){
        ...
        $.ajax({
         ...
         url:"{{route('register')}}",
         dataType: 'json',
         data:{_token: $('meta[name="csrf-token"]').attr('content'), first_name:first_name, last_name:last_name, email:email, password:password, 
